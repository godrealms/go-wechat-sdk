...
func (c *Client) SetInvoiceBizAttr(action string, req *SetBizAttrRequest) (*Resp, error) {
	// 构造请求URL
	path := fmt.Sprintf("/card/invoice/setbizattr?action=%s&access_token=%s", action, c.GetAccessToken())
...
func (c *Client) GetAuthData(req *GetAuthDataRequest) (*GetAuthDataResult, error) {
	// 构造请求URL
	path := fmt.Sprintf("/card/invoice/getauthdata?access_token=%s", c.GetAccessToken())
...
func (c *Client) GetAuthUrl(req *GetAuthUrlRequest) (*GetAuthUrlResult, error) {
	// 构造请求URL
	path := fmt.Sprintf("/card/invoice/getauthurl?access_token=%s", c.GetAccessToken())
...
func (c *Client) RejectInsert(req *RejectInsertRequest) (*Resp, error) {
	// 构造请求URL
	path := fmt.Sprintf("/card/invoice/rejectinsert?access_token=%s", c.GetAccessToken())
