...
func (c *Client) BatchGetUserInfo(req *BatchGetUserInfoRequest) (*BatchGetUserInfoResult, error) {
	// 构造请求URL
	path := fmt.Sprintf("/cgi-bin/user/info/batchget?access_token=%s", c.GetAccessToken())
...
func (c *Client) UpdateRemark(openid string, remark string) (*Resp, error) {
	// 构造请求URL
	path := fmt.Sprintf("/cgi-bin/user/info/updateremark?access_token=%s", c.GetAccessToken())
...
func (c *Client) GetBlacklist(beginOpenid string) (*GetBlacklistResult, error) {
	// 构造请求URL
	path := fmt.Sprintf("/cgi-bin/tags/members/getblacklist?access_token=%s", c.GetAccessToken())
...
func (c *Client) BatchBlacklist(openidList []string) (*Resp, error) {
	// 构造请求URL
	path := fmt.Sprintf("/cgi-bin/tags/members/batchblacklist?access_token=%s", c.GetAccessToken())
...
func (c *Client) BatchUnblacklist(openidList []string) (*Resp, error) {
	// 构造请求URL
	path := fmt.Sprintf("/cgi-bin/tags/members/batchunblacklist?access_token=%s", c.GetAccessToken())
