...
func (c *Client) QueryFee(request *QueryFeeRequest) (*QueryFeeResult, error) {
	...
	err := c.Https.Post(c.Ctx, fmt.Sprintf("/nontax/queryfee?access_token=%s", c.GetAccessToken()), request, result)
	if err != nil {
		return nil, err
	}
	return result, nil
...
func (c *Client) UnifiedOrder(request *UnifiedOrderRequest) (*UnifiedOrderResult, error) {
	...
	err := c.Https.Post(c.Ctx, fmt.Sprintf("/nontax/unifiedorder?access_token=%s", c.GetAccessToken()), request, result)
	if err != nil {
		return nil, err
	}
	return result, nil
...
func (c *Client) DownloadBill(request *DownloadBillRequest) (*DownloadBillResult, error) {
	...
	err := c.Https.Post(c.Ctx, fmt.Sprintf("/nontax/downloadbill?access_token=%s", c.GetAccessToken()), request, result)
	if err != nil {
		return nil, err
	}
	return result, nil
...
func (c *Client) NotifyInconsistentOrder(request *NotifyInconsistentOrderRequest) (*Resp, error) {
	result := &Resp{}
	err := c.Https.Post(c.Ctx, fmt.Sprintf("/nontax/notifyinconsistentorder?access_token=%s", c.GetAccessToken()), request, result)
	if err != nil {
		return nil, err
	}
	return result, nil
...
func (c *Client) MockNotification(request *MockNotificationRequest) (*Resp, error) {
	result := &Resp{}
	err := c.Https.Post(c.Ctx, fmt.Sprintf("/nontax/mocknotification?access_token=%s", c.GetAccessToken()), request, result)
	if err != nil {
		return nil, err
	}
	return result, nil
...
func (c *Client) MockQueryFee(request *MockQueryFeeRequest) (*Resp, error) {
	result := &Resp{}
	err := c.Https.Post(c.Ctx, fmt.Sprintf("/nontax/mockqueryfee?access_token=%s", c.GetAccessToken()), request, result)
	if err != nil {
		return nil, err
	}
	return result, nil
...
func (c *Client) MicroPay(request *MicroPayRequest) (*MicroPayResult, error) {
	...
	err := c.Https.Post(c.Ctx, fmt.Sprintf("/nontax/micropay?access_token=%s", c.GetAccessToken()), request, result)
	if err != nil {
		return nil, err
	}
	return result, nil
...
func (c *Client) GetOrderList(request *GetOrderListRequest) (*GetOrderListResult, error) {
	...
	err := c.Https.Post(c.Ctx, fmt.Sprintf("/nontax/getorderlist?access_token=%s", c.GetAccessToken()), request, result)
	if err != nil {
		return nil, err
	}
	return result, nil
...
func (c *Client) Refund(request *RefundRequest) (*RefundResult, error) {
	result := &RefundResult{}
	err := c.Https.Post(c.Ctx, fmt.Sprintf("/nontax/refund?access_token=%s", c.GetAccessToken()), request, result)
	if err != nil {
		return nil, err
	}
	return result, nil
...
func (c *Client) GetOrder(request *GetOrderRequest) (*GetOrderResult, error) {
	...
	err := c.Https.Post(c.Ctx, fmt.Sprintf("/nontax/getorder?access_token=%s", c.GetAccessToken()), request, result)
	if err != nil {
		return nil, err
	}
	return result, nil
