...
func (c *Client) UpdateTag(id int64, name string) (*Resp, error) {
	// 构造请求URL
	path := fmt.Sprintf("/cgi-bin/tags/update?access_token=%s", c.GetAccessToken())
...
func (c *Client) DeleteTag(id int64) (*Resp, error) {
	// 构造请求URL
	path := fmt.Sprintf("/cgi-bin/tags/delete?access_token=%s", c.GetAccessToken())
...
func (c *Client) GetTagFans(req *GetTagFansRequest) (*GetTagFansResult, error) {
	// 构造请求URL
	path := fmt.Sprintf("/cgi-bin/user/tag/get?access_token=%s", c.GetAccessToken())
...
func (c *Client) BatchTagging(openidList []string, tagid int64) (*Resp, error) {
	// 构造请求URL
	path := fmt.Sprintf("/cgi-bin/tags/members/batchtagging?access_token=%s", c.GetAccessToken())
...
func (c *Client) BatchUntagging(openidList []string, tagid int64) (*Resp, error) {
	// 构造请求URL
	path := fmt.Sprintf("/cgi-bin/tags/members/batchuntagging?access_token=%s", c.GetAccessToken())
...
func (c *Client) GetTagidList(openid string) (*GetTagidListResult, error) {
	// 构造请求URL
	path := fmt.Sprintf("/cgi-bin/tags/getidlist?access_token=%s", c.GetAccessToken())
