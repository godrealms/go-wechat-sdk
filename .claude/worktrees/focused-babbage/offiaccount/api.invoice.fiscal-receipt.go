...
func (c *Client) GetFiscalAuthData(request *GetFiscalAuthDataRequest) (*GetFiscalAuthDataResult, error) {
	...
	err := c.Https.Post(c.Ctx, fmt.Sprintf("/card/invoice/getauthdata?access_token=%s", c.GetAccessToken()), request, result)
	if err != nil {
		return nil, err
	}
	return result, nil
...
func (c *Client) GetTicket() (*GetTicketResult, error) {
	...
	err := c.Https.Get(c.Ctx, "/cgi-bin/ticket/getticket", c.TokenQuery(query), result)
	if err != nil {
		return nil, err
	}
	return result, nil
...
func (c *Client) RejectInsertFiscal(request *RejectInsertFiscalRequest) (*Resp, error) {
	result := &Resp{}
	err := c.Https.Post(c.Ctx, fmt.Sprintf("/card/invoice/rejectinsert?access_token=%s", c.GetAccessToken()), request, result)
	if err != nil {
		return nil, err
	}
	return result, nil
...
func (c *Client) SetFiscalInvoiceUrl() (*SetInvoiceUrlResult, error) {
	...
	err := c.Https.Post(c.Ctx, fmt.Sprintf("/card/invoice/seturl?access_token=%s", c.GetAccessToken()), body, result)
	if err != nil {
		return nil, err
	}
	return result, nil
...
func (c *Client) GetPlatformPdf(request *GetPlatformPdfRequest) (*GetPlatformPdfResult, error) {
	...
	err := c.Https.Post(c.Ctx, fmt.Sprintf("/card/invoice/platform/getpdf?access_token=%s", c.GetAccessToken()), request, result)
	if err != nil {
		return nil, err
	}
	return result, nil
...
func (c *Client) UpdateInvoicePlatformStatus(request *UpdateInvoicePlatformStatusRequest) (*Resp, error) {
	result := &Resp{}
	err := c.Https.Post(c.Ctx, fmt.Sprintf("/card/invoice/platform/updatestatus?access_token=%s", c.GetAccessToken()), request, result)
	if err != nil {
		return nil, err
	}
	return result, nil
...
func (c *Client) GetFiscalAuthUrl(request *GetFiscalAuthUrlRequest) (*GetFiscalAuthUrlResult, error) {
	...
	err := c.Https.Post(c.Ctx, fmt.Sprintf("/nontax/getbillauthurl?access_token=%s", c.GetAccessToken()), request, result)
	if err != nil {
		return nil, err
	}
	return result, nil
...
func (c *Client) CreateFiscalCard(request *CreateFiscalCardRequest) (*CreateFiscalCardResult, error) {
	...
	err := c.Https.Post(c.Ctx, fmt.Sprintf("/nontax/createbillcard?access_token=%s", c.GetAccessToken()), request, result)
	if err != nil {
		return nil, err
	}
	return result, nil
...
func (c *Client) InsertFiscalInvoice(request *InsertFiscalInvoiceRequest) (*InsertInvoiceResult, error) {
	...
	err := c.Https.Post(c.Ctx, fmt.Sprintf("/nontax/insertbill?access_token=%s", c.GetAccessToken()), request, result)
	if err != nil {
		return nil, err
	}
	return result, nil
...
func (c *Client) SetPlatformPdf(pdfFilePath string) (*SetPdfResult, error) {
	result := &SetPdfResult{}
	// 使用通用的Post方法发送文件
	err := c.Https.Post(c.Ctx, fmt.Sprintf("/card/invoice/platform/setpdf?access_token=%s", c.GetAccessToken()), pdfFilePath, result)
	return result, err
}
