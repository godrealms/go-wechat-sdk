...
func (c *Client) ApplyWxaStore(req *ApplyWxaStoreRequest) (*ApplyWxaStoreResult, error) {
	// 构造请求URL
	path := fmt.Sprintf("/wxa/apply_merchant?access_token=%s", c.GetAccessToken())
...
func (c *Client) ModifyWxaStore(req *ModifyWxaStoreRequest) (*Resp, error) {
	// 构造请求URL
	path := fmt.Sprintf("/wxa/modify_merchant?access_token=%s", c.GetAccessToken())
...
func (c *Client) SearchMapPoi(req *SearchMapPoiRequest) (*SearchMapPoiResult, error) {
	// 构造请求URL
	path := fmt.Sprintf("/wxa/search_map_poi?access_token=%s", c.GetAccessToken())
...
func (c *Client) AddStore(req *AddStoreRequest) (*AddStoreResult, error) {
	// 构造请求URL
	path := fmt.Sprintf("/wxa/add_store?access_token=%s", c.GetAccessToken())
...
func (c *Client) GetStoreInfo(req *GetStoreInfoRequest) (*GetStoreInfoResult, error) {
	// 构造请求URL
	path := fmt.Sprintf("/wxa/get_store_info?access_token=%s", c.GetAccessToken())
...
func (c *Client) GetStoreList(req *GetStoreListRequest) (*GetStoreListResult, error) {
	// 构造请求URL
	path := fmt.Sprintf("/wxa/get_store_list?access_token=%s", c.GetAccessToken())
...
func (c *Client) DelStore(req *DelStoreRequest) (*Resp, error) {
	// 构造请求URL
	path := fmt.Sprintf("/wxa/del_store?access_token=%s", c.GetAccessToken())
...
func (c *Client) UpdateStore(req *UpdateStoreRequest) (*UpdateStoreResult, error) {
	// 构造请求URL
	path := fmt.Sprintf("/wxa/update_store?access_token=%s", c.GetAccessToken())
...
func (c *Client) CreateMapPoi(req *CreateMapPoiRequest) (*CreateMapPoiResult, error) {
	// 构造请求URL
	path := fmt.Sprintf("/wxa/create_map_poi?access_token=%s", c.GetAccessToken())
