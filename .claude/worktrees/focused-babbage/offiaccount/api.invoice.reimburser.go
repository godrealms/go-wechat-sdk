...
func (c *Client) GetInvoiceInfo(req *GetInvoiceInfoRequest) (*GetInvoiceInfoResult, error) {
	// 构造请求URL
	path := fmt.Sprintf("/card/invoice/reimburse/getinvoiceinfo?access_token=%s", c.GetAccessToken())
...
func (c *Client) UpdateInvoiceReimburseStatus(req *UpdateInvoiceReimburseStatusRequest) (*Resp, error) {
	// 构造请求URL
	path := fmt.Sprintf("/card/invoice/reimburse/updateinvoicestatus?access_token=%s", c.GetAccessToken())
...
func (c *Client) UpdateInvoiceReimburseStatusBatch(req *UpdateInvoiceReimburseStatusBatchRequest) (*Resp, error) {
	// 构造请求URL
	path := fmt.Sprintf("/card/invoice/reimburse/updatestatusbatch?access_token=%s", c.GetAccessToken())
...
func (c *Client) GetInvoiceBatch(req *GetInvoiceBatchRequest) (*GetInvoiceBatchResult, error) {
	// 构造请求URL
	path := fmt.Sprintf("/card/invoice/reimburse/getinvoicebatch?access_token=%s", c.GetAccessToken())
