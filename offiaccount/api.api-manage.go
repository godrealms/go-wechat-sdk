...
func (c *Client) GetApiQuota(ctx context.Context, cgiPath string) (*ApiQuotaResp, error) {
...
// rid 为调用接口时返回的rid参数
func (c *Client) GetRidInfo(ctx context.Context, rid string) (*RidInfoResp, error) {
	token, err := c.AccessTokenE(ctx)
	if err != nil {
		return nil, err
	}
